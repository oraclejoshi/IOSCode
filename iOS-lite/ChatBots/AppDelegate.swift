...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func setDefaults() -> Void {
        ...
        if( UserDefaults.standard.object(forKey: kBaseURL) == nil ){
            UserDefaults.standard.set("http://97ba3a39.ngrok.io", forKey: kBaseURL)
            UserDefaults.standard.set(true, forKey: kIsBotsSpeakerON)
        }

        if( UserDefaults.standard.object(forKey: kWebhookChannelID) == nil ){
            UserDefaults.standard.set("8519E87B-FE8E-44C0-92C0-D716E962750B", forKey: kWebhookChannelID)
        }
    ...
    func establishWSConnection() -> Void {
        ...
        var _username = OMCBotManager.sharedInstance.randomString(length: 4)
        ...
        if( UserDefaults.standard.object(forKey: "username") != nil ){
            ...
            UserDefaults.standard.set(_username, forKey: kUsername)
        }
        
        OMCBotManager.sharedInstance.establishConnection( host: host, userName: _username )
    }
